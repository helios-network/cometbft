...
func (env *Environment) GetRoutes() RoutesMap {
	return RoutesMap{
		...
		"blockchain_locate_txs":              rpc.NewRPCFunc(env.BlockchainLocateTxsInfo, "minHeight,maxHeight,hexAddressString,accAddressString", rpc.Cacheable()),
		"blockchain_locate_not_empty_blocks": rpc.NewRPCFunc(env.BlockchainLocateNotEmptyBlocksInfo, "minHeight,maxHeight", rpc.Cacheable()),
