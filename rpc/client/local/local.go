...
func (c *Local) BlockchainLocateNotEmptyBlocksInfo(_ context.Context, minHeight, maxHeight int64) (*ctypes.ResultBlockchainInfo, error) {
	return c.env.BlockchainLocateNotEmptyBlocksInfo(c.ctx, minHeight, maxHeight)
}
